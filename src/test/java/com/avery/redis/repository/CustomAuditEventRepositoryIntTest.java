package com.avery.redis.repository;

import com.avery.redis.RedisApp;
import com.avery.redis.config.Constants;
import com.avery.redis.config.audit.AuditEventConverter;
import com.avery.redis.domain.PersistentAuditEvent;
...
import static com.avery.redis.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
